...
defmodule GoogleApi.Storage.V1.Api.Buckets do
  ...
  def storage_buckets_lock_retention_policy(connection, bucket, if_metageneration_match, optional_params \\ [], opts \\ []) do
    optional_params_config = %{
      :"alt" => :query,
      :"fields" => :query,
      :"key" => :query,
  ...
  def storage_buckets_test_iam_permissions(connection, bucket, permissions, optional_params \\ [], opts \\ []) do
    optional_params_config = %{
      :"alt" => :query,
      :"fields" => :query,
      :"key" => :query,
