...
defmodule GoogleApi.Storage.V1.Api.Objects do
  ...
  def storage_objects_compose(connection, destination_bucket, destination_object, optional_params \\ [], opts \\ []) do
  ...
  def storage_objects_copy(connection, source_bucket, source_object, destination_bucket, destination_object, optional_params \\ [], opts \\ []) do
    optional_params_config = %{
      :"alt" => :query,
      :"fields" => :query,
      :"key" => :query,
    ...
    request =
      Request.new
      |> Request.method(:post)
      |> Request.url("/storage/v1/b/{sourceBucket}/o/{sourceObject}/copyTo/b/{destinationBucket}/o/{destinationObject}", %{
  ...
  def storage_objects_get_iam_policy(connection, bucket, object, optional_params \\ [], opts \\ []) do
    optional_params_config = %{
      :"alt" => :query,
      :"fields" => :query,
      :"key" => :query,
  ...
  def storage_objects_insert_resumable(connection, bucket, upload_type, optional_params \\ [], opts \\ []) do
    optional_params_config = %{
      :"alt" => :query,
      :"fields" => :query,
      :"key" => :query,
  ...
  def storage_objects_insert_simple(connection, bucket, upload_type, metadata, data, optional_params \\ [], opts \\ []) do
    optional_params_config = %{
      :"alt" => :query,
      :"fields" => :query,
      :"key" => :query,
  ...
  def storage_objects_rewrite(connection, source_bucket, source_object, destination_bucket, destination_object, optional_params \\ [], opts \\ []) do
    optional_params_config = %{
      :"alt" => :query,
      :"fields" => :query,
      :"key" => :query,
    ...
    request =
      Request.new
      |> Request.method(:post)
      |> Request.url("/storage/v1/b/{sourceBucket}/o/{sourceObject}/rewriteTo/b/{destinationBucket}/o/{destinationObject}", %{
         "sourceBucket" => URI.encode_www_form(source_bucket),
         "sourceObject" => URI.encode_www_form(source_object),
         "destinationBucket" => URI.encode_www_form(destination_bucket),
         "destinationObject" => URI.encode_www_form(destination_object)
  ...
  def storage_objects_set_iam_policy(connection, bucket, object, optional_params \\ [], opts \\ []) do
    optional_params_config = %{
      :"alt" => :query,
      :"fields" => :query,
      :"key" => :query,
  ...
  def storage_objects_test_iam_permissions(connection, bucket, object, permissions, optional_params \\ [], opts \\ []) do
    optional_params_config = %{
      :"alt" => :query,
      :"fields" => :query,
      :"key" => :query,
